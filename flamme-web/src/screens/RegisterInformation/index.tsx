...
import { ButtonWhiteEdit } from "../../components/ButtonWhiteEdit/ButtonWhiteEdit";
...
function RegisterInformation() {
  ...
  return (
    <div className="RegisterInformation">
      ...
      <div className="m-6">
        <ButtonWhiteEdit label="Editar informações" onclick={() => { 
          //ADICIONAR EFEITO QUE FAZ BOTÕES DE SALVAR-CANCELAR APARECEREM
        }}/>
      </div>
